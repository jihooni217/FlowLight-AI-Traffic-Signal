...
|--------|----------------|
| 🔍 Traffic Analysis | Analyze traffic volume and congestion |
| 📝 Signal Planning | Generate optimized signal timing |
| 📊 Plan Evaluation | Compare and evaluate the generated plan |
| 🛡 Guardrail | Validate signal constraints and JSON format |
| 🚦 Simulation | Apply only verified plans to CityFlow |
